...
impl Engine {
    ...
    // TODO: All this registration stuff is pretty gross. Can we clean it up somehow?
    fn enqueue(&mut self, future: impl Future<Output = ()> + 'static) {
        self.active.push_back(MyTask::new(
            self.next_task_id,
            Box::pin(future),
...
impl MyTask {
    fn new(id: usize, future: Pin<Box<dyn Future<Output = ()>>>, waker: Arc<MyWaker>) -> Self {
